<template>
  <div :class="['fixed top-0 left-0 w-full z-50 transition-all duration-300', { 'bg-neutral_600/90 backdrop-blur': isScrolled, 'bg-neutral_600': !isScrolled }]">
    <header class="font-['Noto Serif TC'] border-b-solid border-b-1 border-b-white/25% flex h-20 items-center px-6 z-20 relative">
