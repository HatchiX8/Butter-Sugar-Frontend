      ...
      <n-collapse-item v-for="chapter in chapters" :key="chapter.id">
        <template #header>
          <div class="flex w-full items-center justify-around">
            ...
            <div class="ml-auto">
              <button @click.stop="editChapter(chapter.id)" 
                      class="bg-secondaryLight text-white border-none rounded-md px-4 py-2 mr-4">編輯</button>
            </div>
          </div>
        </template>
